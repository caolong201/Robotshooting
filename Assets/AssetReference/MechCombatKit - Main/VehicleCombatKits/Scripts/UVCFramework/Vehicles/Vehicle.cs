...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class Vehicle : MonoBehaviour
	{
        ...
        public void SetHealth(float startingHealth, float healthCapacity)
        {
            Debug.Log("SetHealth:" + startingHealth);
            var healthComp = GetComponent<Health>();
            foreach (var healthCompDamageable in healthComp.Damageables)
            {
                healthCompDamageable.HealthCapacity = healthCapacity;
                healthCompDamageable.SetHealth(startingHealth);
            }
        }
